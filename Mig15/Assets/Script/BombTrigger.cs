...
public class BombTrigger : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            HP += linDamage * multDamage;
            if (HP < MHP) other.gameObject.GetComponent<playerGetDamage>().hp -= HP;
            else other.gameObject.GetComponent<playerGetDamage>().hp = 0.1f;
            Destroy(gameObject);
        }
    }
}
